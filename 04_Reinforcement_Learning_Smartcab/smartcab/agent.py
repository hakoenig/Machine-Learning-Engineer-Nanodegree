...
class LearningAgent(Agent):
    ...
    def get_maxQ(self, state):
        ...
        if state in self.Q:
            ...
            #for action, current_q_value in self.Q[state].items():
            #    if maxQ:
            #        if current_q_value > maxQ:
            #            maxQ = current_q_value
            #    else:
            #        maxQ = current_q_value
    ...
    def get_best_action(self, state):
        ...
        return random.choice([action for action, q_value in self.Q[state].items() if q_value == maxQ])
